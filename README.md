...
Independent AI-systems research and engineering by **Samuel Lawson**. Local-first, deterministic, governed systems — evidence over confidence.

## Sealed research (byte-verifiable)
- **[TCAIN](https://github.com/darksciencedivision-ctrl/trajectory-constrained-adversarial-intelligence-nodes)** — trajectory-constrained adversarial intelligence nodes: governed multi-model reasoning under structured perturbation. Sealed `v1.0.1`; `SHA256SUMS.txt` + `VERIFYING.md`.
- **[ATG](https://github.com/darksciencedivision-ctrl/adversarial-trajectory-graphs)** — external adversarial supervision for long-horizon autonomous projects. Sealed `v1.0.2`; byte-verifiable.
- **[CRA](https://github.com/darksciencedivision-ctrl/cognitive-resource-allocation)** — cognitive resource allocation: adaptive cognitive tiering and task-comprehension handshakes. Research baseline v1.0.
- **[Governed Concurrence](https://github.com/darksciencedivision-ctrl/governed-concurrence)** — concurrence-not-consensus orchestration; predecessor to TCAIN §4.
